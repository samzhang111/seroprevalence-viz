...
export const updateSettings = (settingsContainer, chartProps) => {
  ...
  let linkc = settingsContainer.select(".link")
  ...
  linkc
    ...
    .text(`10,000 posterior draws, with mean and 90% credible interval.        Generated by https://larremorelab.github.io/covid-serology`)
...
export const makeChart = (chartProps) => {
  ...
  settingsContainer.append("text").attr("class", "link")
